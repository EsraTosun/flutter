  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            CheckboxListTile(   //Kullanıcının seçim yapmasını sağlar
              value: checkBoxState,
              onChanged: (secildi) {
                setState(() {
            ...
            RadioListTile<String>(  //Verdiğimiz seçeneklerden sadece bir tanesini seçmesi sağlanır
              value: "Ankara",
              groupValue: sehir,
              onChanged: (deger) {
                setState(() {
            ...
            Slider(
              ...
              min: 10,
              max: 20,
              divisions: 20,  //Aralık sayısını belirler
              label: sliderDeger.toString(),
            ),


            DropdownButton<String>(items: [  //Listelediği verilerden seçim yapmak
            ...
            DropdownButton<String>(items: sehirler.map((oankiSehir) {
              return DropdownMenuItem<String>(   //Tek tek yazmak yerine list yapısı kullanarak oluşturma
